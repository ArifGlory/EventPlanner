        ...
        <div class="container pt-5 pb-5 pt-md-5 pb-md-10">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-5 align-items-center">
                <div class="col-lg-6 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start order-2 order-lg-0"
                    ...
                    <h1 class="display-1 mb-5 mx-md-n5 mx-lg-0">Produk  </h1>
        ...
        <div class="container py-14 py-md-16">
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mt-4">
                @if(count($produk) > 0)
                    @foreach($produk as $val)
                        <div class="project item col-md-4 col-xl-4 product">
                            <figure class="lift rounded mb-6"><a href="{{url('/detail-produk/'.encodeId($val->product_id))}}"> <img src="{{ getImageOri($val->product_image)  }}" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                                    ...
                                    <a href="{{url('/detail-produk/'.encodeId($val->product_id))}}">
                                        <h2 class="post-title h3"> {{$val->product_name}} </h2>
                                    </a>
                                    <p>
                                        <strong> Rp. {{ format_angka_indo($val->product_price) }} </strong> <del> {{ format_angka_indo($val->product_old_price) }} </del>
                                    </p>
                ...
                @else
                    ...
                    <a href="{{ url(('/produk'))  }}"> <i class="uil uil-backward"></i> Kembali </a>
                @endif
            </div>
            <!-- /.row -->
        </div>
