...
-- Generation Time: 2023-05-09 15:07:18.5280
-- -------------------------------------------------------------
...
CREATE TABLE `event` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `event_pemilik` int DEFAULT NULL,
...
(86, 'planner1@gmail.com', '$2y$10$c0zKtegOV49gwP/uQjszv.OLcOR.w3RC6XD2yYPLDDBs.Z7Z9k.VC', 'Rajabasa EO', NULL, '', '1', '0812345678', NULL, NULL, 'user', '2023-05-09 10:40:27', '2023-05-09 15:04:24', NULL, NULL);
